...
document.querySelector(".btn-roll").addEventListener("click", function(){
	//Anonymous function, cannot be used outside of this context
	if(gamePlaying){
		// 1. Random Number
	...
	if (dice !== 1) {
		...
		//Next player
		// ternary operator to switch between players when the dice is 1
		nextPlayer();
		}
	}
});
...
// function for showing the rules and removing other items
...
function gameRules(){
	...
	document.getElementById("current-0").style.visibility = "hidden";
	document.getElementById("name-0").style.visibility = "hidden";
	document.getElementById("name-1").style.visibility = "hidden";
	document.getElementById("score-0").style.visibility = "hidden";
	document.getElementById("score-1").style.visibility = "hidden";
	document.querySelector(".rules-panel").style.visibility = "visible";
	
}

// calling the game rules function on click
